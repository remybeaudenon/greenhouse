...
#define GPIO_GND                19  // GPIO(19) J2:18  <== Ground OSOYOO  
#define GPIO_ENC_CLK            20  // GPIO(20) J2:17  <== Encoder Clock  20/T  
//                                     GPIO(21) J2:16  ==> [OLED_RST]      
#define GPIO_ENC_DT             26  // GPIO(26) J2:15  <==  Encoder Data  
...
#define GPIO_U1TXD              33  // GPIO(33) J2:12  ==> Ground OSOYOO 
...
#define GPIO_FORCE_LED           2  // GPIO(2)  J3:13  ==> S02 MOSFET-N 100V/14A
#define GPIO_VBAT_PIN            1  // GPIO(1)  J3:12  <== 

#define GPIO_SDA_PIN            45  // GPIO(45) J3:06  <==> I2C SDA LCD  
